...
public:
	...
	//InGame
	void EnterPlayer(ClientSessionRef session, int32 selectedCharacterID = Define::DefaultKey);
	void AddGameObject(GameObjectRef object, ClientSessionRef execptSession = nullptr);
	void BroadCast(SendBufferRef packet, ClientSessionRef execptSession = nullptr);
